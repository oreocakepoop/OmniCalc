  ...
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
      <div className="glass-panel  p-10 sm:p-12 space-y-8">
        <div className="flex bg-transparent  p-2 mb-10 border border-charcoal/20">
          <button
            onClick={() => setUnit('metric')}
            className={`flex-1 py-4 text-xl font-medium  transition-colors ${unit === 'metric' ? 'bg-charcoal' + ' text-white shadow-sm' : 'text-charcoal/70 hover:text-charcoal'}`}
          >
            Metric (cm/kg)
          </button>
          <button
            onClick={() => setUnit('imperial')}
            className={`flex-1 py-4 text-xl font-medium  transition-colors ${unit === 'imperial' ? 'bg-charcoal' + ' text-white shadow-sm' : 'text-charcoal/70 hover:text-charcoal'}`}
          >
            Imperial (in/lbs)
          </button>
        </div>
      ...
      <div className="glass-panel  p-10 sm:p-12 flex flex-col justify-center items-center text-center space-y-10">
