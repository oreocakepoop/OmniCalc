...
export function AgeCalc() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto glass-panel  p-10 sm:p-12 space-y-12">
      <div className="max-w-xl mx-auto">
        ...
        <input
          ...
          className={`w-full bg-white text-charcoal border border-charcoal/20  px-6 py-5 text-2xl focus:outline-none text-center focus-visible:ring-charcoal`}
        />
      </div>

      {age ? (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div className="bg-charcoal  p-10 text-center border border-charcoal/20">
        ...
        <div className="h-64 flex items-center justify-center text-charcoal/50 text-2xl border-4 border-dashed border-charcoal/20  uppercase tracking-widest font-bold">
