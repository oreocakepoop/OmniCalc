...
export function PercentageCalc() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto space-y-8">
      {/* What is X% of Y? */}
      <div className="glass-panel rounded-3xl p-10 sm:p-12">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-6">
          ...
          <input 
            ...
            className={`w-full sm:w-32 bg-white text-charcoal border border-charcoal/20 rounded-xl px-6 py-5 text-3xl text-center focus:outline-none focus-visible:ring-charcoal`}
            placeholder="X"
          />
          ...
          <input 
            ...
            className={`w-full sm:w-48 bg-white text-charcoal border border-charcoal/20 rounded-xl px-6 py-5 text-3xl text-center focus:outline-none focus-visible:ring-charcoal`}
            placeholder="Y"
          />
          <span className="text-charcoal/50 text-3xl">=</span>
          <div className={`w-full sm:w-64 bg-white text-charcoal border border-charcoal/20 rounded-xl px-6 py-5 text-4xl text-center font-mono text-mustard min-h-[80px] flex items-center justify-center`}>
