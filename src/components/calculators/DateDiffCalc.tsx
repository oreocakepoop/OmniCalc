...
export function DateDiffCalc() {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
      ...
      <div className="glass-panel  p-10 sm:p-12 flex flex-col justify-center text-center space-y-8">
        {days !== null ? (
          <>
          ...
          <div className="h-full min-h-[200px] flex items-center justify-center text-charcoal/50 text-2xl border-4 border-dashed border-charcoal/20  uppercase tracking-widest font-bold">
            Select both dates
          </div>
        )}
      </div>
